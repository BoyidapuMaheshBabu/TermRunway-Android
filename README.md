# TermRunway 1.0.0 — Reference UI Build

Fresh native Android / Kotlin / Jetpack Compose implementation.

Completely offline: only the user's name is requested. Financial data is stored locally on-device.
